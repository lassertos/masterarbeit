\input{include/NIKR_header.tex}

\begin{document}
% --- Titelseite, Danksagung, Einverständniserklärung --------------------------
\pagestyle{empty}
\input{include/NIKR_title.tex}
...
\input{content/03_stand_der_technik.tex}
\input{content/04_anforderungsanalyse.tex}
\input{content/05_konzeption.tex}
\input{content/06_prototypische_implementierung.tex}
\input{content/07_diskussion.tex}
\input{content/08_zusammenfassung_und_ausblick.tex}
