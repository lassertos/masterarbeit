...
Zusätzlich zu den oben genannten Kategorien sollen in Abschnitt \ref{collaborative-approaches} auch unterschiedliche kollaborative Ansätze betrachtet werden. Schließlich werden in Abschnitt \ref{challenges-online-ides} die Herausforderungen und in Abschnitt \ref{advantages-online-ides} die Vorteile von online IDEs betrachtet.
