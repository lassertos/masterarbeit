\input{include/NIKR_header}

\begin{document}
% --- Titelseite, Danksagung, Einverständniserklärung --------------------------
\pagestyle{empty}
\input{include/NIKR_title}
...
\input{content/03_systematische_literaturrecherche.tex}
\input{content/04_anforderungsanalyse.tex}
\input{content/05_stand_der_technik.tex}
\input{content/06_konzeption.tex}
